                        ...
                        <Link to={`/messages/${chat._id}`} key={chat._id} style={{ textDecoration: 'none' }}>
                            ...
                            >
                                ...
                                <div className="flex-1 select-none overflow-hidden py-2">
                                    <h3 className="font-medium leading-tight text-textCustom">{chat.name}</h3>
                                    <p
                                        className="w-[100%] overflow-hidden overflow-ellipsis whitespace-nowrap font-be
                                        font-normal text-textBlackGray"
                                    >
