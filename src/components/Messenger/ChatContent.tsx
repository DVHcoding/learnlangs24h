                ...
                <ul className="mx-2 mb-14 mt-2 flex flex-col gap-2">
                    ...
                    <li className="flex gap-2">
                        <p className="ml-auto max-w-[33rem] rounded-2xl bg-blue-500 p-2 text-white">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias unde commodi illum laboriosam corporis iure
                            eum voluptatibus eveniet, nesciunt ipsam voluptates nisi sequi fugit, dicta neque voluptas inventore?
