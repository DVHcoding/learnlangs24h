...
import { Card, importPreviewsToSentences, updateVocaPreviews } from '@store/reducer/vocaReducer';
...
const ImportSentenceCard: React.FC<ImportCardProps> = ({ open, onClose }) => {
    /* ########################################################################## */
    /*                                    HOOKS                                   */
    /* ########################################################################## */
    ...
    const handleImport = () => {
        dispatch(importPreviewsToSentences());
...
export default ImportSentenceCard;
